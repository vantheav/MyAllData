                ...
                <v-list dense >
                    ...
                    <v-list-item-group v-model="item" active-class="active-list-item">
                        <v-subheader class="questrial font-weight-bold ml-5">FEED</v-subheader>
                         <v-list-item  v-for="item in items" :key="item" dense style="height:20px" >
                            <v-list-item-action>
...
export default {
    data(){
        return {
            item: 1,
            items: [
                {text: 'News Feed', icon: 'mdi-animation'},
                {text: 'Pages', icon: 'fa-comments'},
                {text: 'Pages Feed', icon: 'fa-briefcase'},
                {text: 'Events', icon: 'mdi-calendar-clock'},
                {text: 'Saved', icon: 'fa-bookmark'},
                {text: 'Reccomendations', icon: 'mdi-led-on'},
